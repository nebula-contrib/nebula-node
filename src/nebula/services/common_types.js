...
const SchemaID = module.exports.SchemaID = class {
  constructor(args) {
    this.tag_id = null;
    this.edge_type = null;
    if (args) {
...
const Date = module.exports.Date = class {
  constructor(args) {
    this.year = null;
    this.month = null;
    this.day = null;
...
const Time = module.exports.Time = class {
  constructor(args) {
    this.hour = null;
    this.minute = null;
    this.sec = null;
...
const DateTime = module.exports.DateTime = class {
  constructor(args) {
    this.year = null;
    this.month = null;
    this.day = null;
...
const Value = module.exports.Value = class {
  constructor(args) {
    this.nVal = null;
    this.bVal = null;
    this.iVal = null;
...
const NList = module.exports.NList = class {
  constructor(args) {
    this.values = null;
    if (args) {
...
const NMap = module.exports.NMap = class {
  constructor(args) {
    this.kvs = null;
    if (args) {
  ...
  write (output) {
    ...
    if (this.kvs !== null && this.kvs !== undefined) {
      ...
      for (let kiter10 in this.kvs) {
        if (this.kvs.hasOwnProperty(kiter10)) {
          let viter11 = this.kvs[kiter10];
...
const NSet = module.exports.NSet = class {
  constructor(args) {
    this.values = null;
    if (args) {
      if (args.values !== undefined && args.values !== null) {
...
const Row = module.exports.Row = class {
  constructor(args) {
    this.values = null;
    if (args) {
      if (args.values !== undefined && args.values !== null) {
...
const DataSet = module.exports.DataSet = class {
  constructor(args) {
...
const Coordinate = module.exports.Coordinate = class {
  constructor(args) {
    this.x = null;
    this.y = null;
    if (args) {
...
const Point = module.exports.Point = class {
  constructor(args) {
    this.coord = null;
    if (args) {
...
const LineString = module.exports.LineString = class {
  constructor(args) {
    this.coordList = null;
    if (args) {
...
const Polygon = module.exports.Polygon = class {
  constructor(args) {
...
const Geography = module.exports.Geography = class {
  constructor(args) {
    this.ptVal = null;
    this.lsVal = null;
    this.pgVal = null;
...
const Tag = module.exports.Tag = class {
  constructor(args) {
    this.name = null;
    this.props = null;
    if (args) {
  ...
  write (output) {
    ...
    if (this.props !== null && this.props !== undefined) {
      ...
      for (let kiter52 in this.props) {
        if (this.props.hasOwnProperty(kiter52)) {
          let viter53 = this.props[kiter52];
...
const Edge = module.exports.Edge = class {
  constructor(args) {
    this.src = null;
    this.dst = null;
    this.type = null;
  ...
  write (output) {
    ...
    if (this.props !== null && this.props !== undefined) {
      ...
      output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(this.props));
      for (let kiter64 in this.props) {
        if (this.props.hasOwnProperty(kiter64)) {
          let viter65 = this.props[kiter64];
...
const Step = module.exports.Step = class {
  constructor(args) {
    this.dst = null;
    this.type = null;
    this.name = null;
  ...
  write (output) {
    ...
    if (this.props !== null && this.props !== undefined) {
      ...
      output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(this.props));
      for (let kiter71 in this.props) {
        if (this.props.hasOwnProperty(kiter71)) {
          let viter72 = this.props[kiter71];
...
const HostAddr = module.exports.HostAddr = class {
  constructor(args) {
    this.host = null;
    this.port = null;
    if (args) {
...
const KeyValue = module.exports.KeyValue = class {
  constructor(args) {
    this.key = null;
    this.value = null;
    if (args) {
...
const Duration = module.exports.Duration = class {
  constructor(args) {
    this.seconds = null;
...
const LogInfo = module.exports.LogInfo = class {
  constructor(args) {
    this.log_id = null;
    this.term_id = null;
    if (args) {
...
const DirInfo = module.exports.DirInfo = class {
  constructor(args) {
    this.root = null;
    this.data = null;
    if (args) {
...
const CheckpointInfo = module.exports.CheckpointInfo = class {
  constructor(args) {
    this.space_id = null;
    this.parts = null;
    this.path = null;
  ...
  write (output) {
    ...
    if (this.parts !== null && this.parts !== undefined) {
      ...
      for (let kiter88 in this.parts) {
        if (this.parts.hasOwnProperty(kiter88)) {
          let viter89 = this.parts[kiter88];
...
const LogEntry = module.exports.LogEntry = class {
  constructor(args) {
    this.cluster = null;
    this.log_str = null;
    if (args) {
