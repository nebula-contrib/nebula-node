...
const ProfilingStats = module.exports.ProfilingStats = class {
  constructor(args) {
    this.rows = null;
  ...
  write (output) {
    ...
    if (this.other_stats !== null && this.other_stats !== undefined) {
      ...
      for (let kiter5 in this.other_stats) {
        if (this.other_stats.hasOwnProperty(kiter5)) {
          let viter6 = this.other_stats[kiter5];
...
const PlanNodeBranchInfo = module.exports.PlanNodeBranchInfo = class {
  constructor(args) {
...
const Pair = module.exports.Pair = class {
  constructor(args) {
    this.key = null;
    this.value = null;
    if (args) {
...
const PlanNodeDescription = module.exports.PlanNodeDescription = class {
  constructor(args) {
    this.name = null;
    this.id = null;
...
const PlanDescription = module.exports.PlanDescription = class {
  constructor(args) {
  ...
  write (output) {
    ...
    if (this.node_index_map !== null && this.node_index_map !== undefined) {
      ...
      for (let kiter32 in this.node_index_map) {
        if (this.node_index_map.hasOwnProperty(kiter32)) {
          let viter33 = this.node_index_map[kiter32];
...
const ExecutionResponse = module.exports.ExecutionResponse = class {
  constructor(args) {
...
const AuthResponse = module.exports.AuthResponse = class {
  constructor(args) {
    this.error_code = null;
    this.error_msg = null;
...
const VerifyClientVersionResp = module.exports.VerifyClientVersionResp = class {
  constructor(args) {
    this.error_code = null;
    this.error_msg = null;
    if (args) {
...
const VerifyClientVersionReq = module.exports.VerifyClientVersionReq = class {
  constructor(args) {
    this.version = '3.0.0';
    if (args) {
